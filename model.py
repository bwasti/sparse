...
cifar10_train = torchvision.datasets.CIFAR10(
    cifar10_root, download=True, transform=transforms.ToTensor(), train=True
)
cifar10_test = torchvision.datasets.CIFAR10(
    cifar10_root, download=True, transform=transforms.ToTensor(), train=False
)

mnist_root = "/scratch/bwasti/mnist"
mnist_train = torchvision.datasets.MNIST(
    mnist_root, download=True, transform=transforms.ToTensor(), train=True
)
mnist_test = torchvision.datasets.MNIST(
    mnist_root, download=True, transform=transforms.ToTensor(), train=False
)
...
class SparseNet(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 20, 5, 1)
        self.conv2 = nn.Conv2d(20, 50, 5, 1)
        self.fc1 = ts.SparseLinear(4 * 4 * 50, 512, 0.00, 16)
        # self.fc1 = nn.Linear(4*4*50, 512)
        self.fc2 = ts.SparseLinear(512, 16, 0.00, 16)
        # self.fc2 = nn.Linear(512, 16)
